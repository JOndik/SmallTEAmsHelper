...
{
    public class RuleAssociationCardinality : Rule
    {
        public RuleAssociationCardinality() : base()
        {
            this.name = "ClassDiagram::Association::MissingCardinality";
            this.actions = -1;
        }
        ...
        public override void activate(Wrapper.Model modelArg, string GUID)
        {
            ...
            defectDescription = "Chybajuca kardinalita medzi triedami '";
            model = modelArg;
            ...
            {
                if (String.IsNullOrEmpty(connector.ClientEnd.Cardinality) || String.IsNullOrEmpty(connector.SupplierEnd.Cardinality))
                {
                    if (!isActive)
                    {
                        this.actions = 0;
        ...
        {
            if (String.IsNullOrEmpty(connectorWrapper.WrappedConnector.ClientEnd.Cardinality))
            {
                connectorWrapper.WrappedConnector.ClientEnd.Cardinality = "1..*";
            }

            if (String.IsNullOrEmpty(connectorWrapper.WrappedConnector.SupplierEnd.Cardinality))
            {
                connectorWrapper.WrappedConnector.SupplierEnd.Cardinality = "1..*";
            }
